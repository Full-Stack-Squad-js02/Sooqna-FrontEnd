...
function NavBar({ setSearchData }) {
  ...
  return (
    <Navbar expand="sm" style={{ height: "88px", background: "linear-gradient(59deg, #3A6073, #16222A)", position: "fixed", zIndex: "1", width: "100%", top: "0" }}>
      <Container fluid>
        <img
          src={Logo}
          width="70"
          ...
          <Form className="d-flex">
            ...
            {!isAuthenticated() ? (
              <React.Fragment>
                ...
                <Button variant="outline-warning" style={{ whiteSpace: "nowrap" }} onClick={() => navigate("/signup")}>
                  Sign Up
                </Button>
              </React.Fragment>
            ) : user.role !== "admin" ? (
